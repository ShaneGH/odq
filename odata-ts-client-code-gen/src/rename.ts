import { ComplexTypeOrEnum, ODataComplexTypeProperty, ODataEntitySetNamespaces, ODataEntitySets, ODataServiceConfig, ODataServiceTypes, ODataTypeRef } from "odata-ts-client-shared";
