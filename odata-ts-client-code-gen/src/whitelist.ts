import { ComplexTypeOrEnum, ODataComplexTypeProperty, ODataEntitySetNamespaces, ODataEntitySets, ODataServiceConfig, ODataSingleTypeRef, ODataTypeRef } from "odata-ts-client-shared";
